...
namespace FMODUnity
{
    ...
    public class Settings : ScriptableObject, ISerializationCallbackReceiver
    {
        ...
        public bool IsSettingsInstantiated => Instance != null;
        ...
        public static void Initialize()
        {
            if (instance == null)
            {
                ...
                instance = WeaverAssets.LoadAssetFromBundle<Settings, AncientAspidMod>("FMODStudioSettings");
                instance.OnEnable();
        ...
        private void PopulatePlatformsFromAsset()
        {
            ...
            Platform[] assetPlatforms = WeaverAssets.LoadAssetsOfType<Platform, AncientAspidMod>().ToArray();
        ...
        class DataContainer
        {
            ...
            {
                settings.SpeakerModeSettings = SpeakerModeSettings;
                settings.SampleRateSettings = SampleRateSettings;
                settings.LiveUpdateSettings = LiveUpdateSettings;
                settings.OverlaySettings = OverlaySettings;
                settings.BankDirectorySettings = BankDirectorySettings;
                settings.VirtualChannelSettings = VirtualChannelSettings;
                settings.RealChannelSettings = RealChannelSettings;
        ...
        [SerializeField]
        List<UnityEngine.Object> data_objects = new List<UnityEngine.Object>();
        ...
        public void OnBeforeSerialize()
        {
            ...
            {
                SpeakerModeSettings = this.SpeakerModeSettings,
                SampleRateSettings = this.SampleRateSettings,
                LiveUpdateSettings = this.LiveUpdateSettings,
                OverlaySettings = this.OverlaySettings,
                BankDirectorySettings = this.BankDirectorySettings,
                VirtualChannelSettings = this.VirtualChannelSettings,
                RealChannelSettings = this.RealChannelSettings,
                Platforms = this.Platforms
            }, out data_json, out data_objects);
#endif
        }
        ...
        {
#if !UNITY_EDITOR
            WeaverSerializer.Deserialize<DataContainer>(data_json, data_objects).UpdateSettings(this);
#endif
        }
    }
