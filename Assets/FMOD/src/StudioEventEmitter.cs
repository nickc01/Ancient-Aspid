...
namespace FMODUnity
{
    ...
    public class StudioEventEmitter : EventHandler, ISerializationCallbackReceiver
    {
...
/*#if UNITY_EDITOR
        ...
        {
#if !UNITY_EDITOR
            var container = WeaverSerializer.Deserialize<DataContainer>(stored_data, stored_objects);
            Params = container.Params;
            EventReference = container.EventReference;
#endif
        }
    }
}
